...
\def\xxtitreexo{Control'X -- Axe numérique asservi}
\def\xxsourceexo{\hspace{.2cm} D'après documentation F. Mazet.}
...
\item \textbf{5:} le chariot de masse $M$ encastré à la courroie \textbf{4} considérée inextensible;
